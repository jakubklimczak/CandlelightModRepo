...
export class GameService {
    ...
    public getGames(pagination: PaginatedQuery): Observable<PaginatedResponse<GameListItem>> {
        return this.http.get<PaginatedResponse<GameListItem>>(this.apiUrl + 'GetGamesFromDbPaginatedQuery', { 
