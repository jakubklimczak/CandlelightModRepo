...
namespace Candlelight.Infrastructure.Migrations
{
    ...
    [Migration("20250531165234_UserProfileFavouritesVisibility")]
    partial class UserProfileFavouritesVisibility
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Candlelight.Core.Entities.CustomGameDetails", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Candlelight.Core.Entities.Game", b =>
                {
                    ...
                    b.Property<Guid?>("CustomGameDetailsId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("SteamGameDetailsId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Candlelight.Core.Entities.GameFavourite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Candlelight.Core.Entities.ModFavourite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ModId", "UserId")
                        .IsUnique();

                    b.ToTable("ModFavourites");
                });

            modelBuilder.Entity("Candlelight.Core.Entities.ModReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Candlelight.Core.Entities.ModVersion", b =>
                {
                    ...
                    b.Property<List<string>>("SupportedVersions")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("Candlelight.Core.Entities.UserProfile", b =>
                {
                    ...
                    b.Property<bool>("FavouritesVisible")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Candlelight.Core.Entities.CustomGameDetails", b =>
                {
                    b.HasOne("Candlelight.Core.Entities.Game", "Game")
                        .WithOne("CustomGameDetails")
                        .HasForeignKey("Candlelight.Core.Entities.CustomGameDetails", "GameId")
            ...
            modelBuilder.Entity("Candlelight.Core.Entities.Game", b =>
                {
                    b.Navigation("CustomGameDetails");
